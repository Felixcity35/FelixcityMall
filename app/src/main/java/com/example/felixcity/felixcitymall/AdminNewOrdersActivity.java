...
import com.example.felixcity.felixcitymall.Model.AdminOrders;
        ...
        FirebaseRecyclerAdapter<AdminOrders,AdminOrdersViewHolder> adapter =
                new FirebaseRecyclerAdapter<AdminOrders, AdminOrdersViewHolder>(options) {
                    ...
                    protected void onBindViewHolder(@NonNull AdminOrdersViewHolder holder, final int position, @NonNull AdminOrders model)
                    {
                        ...
                        holder.userTotalPrice.setText("Total Amount= N "+ model.getTotalAmount() );
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                builder.setTitle("Have You Shipped this other products ?");
