...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fullNameEditText = findViewById(R.id.setttings_full_name);
        userPhoneEditText = findViewById(R.id.setttings_phone_number);
        addressEditText = findViewById(R.id.setttings_address);
        profileChangeTextBtn= findViewById(R.id.profile_image_change_settings);
    ...
    private void updateOnlyUserInfo()
    {
        ...
        HashMap<String,Object> userMaps = new HashMap<>();
        userMaps.put("Name",fullNameEditText.getText().toString());
        userMaps.put("address",addressEditText.getText().toString());
        userMaps.put("PhoneOrder",userPhoneEditText.getText().toString());
        ref.child(Prevalent.currentOnlineUser.getPhone()).updateChildren(userMaps);
